...
import {
    FaThLarge, FaSignInAlt, FaClipboardList,
    FaLaptopCode, FaUserCircle, FaSignOutAlt
} from 'react-icons/fa';
...
const StudentSidebar = () => {
    ...
    const links = [
        ...
        { name: 'Join Quiz', path: '/dashboard/join-quiz', icon: <FaSignInAlt /> },
        { name: 'My Results', path: '/dashboard/student-results', icon: <FaClipboardList /> },
        { name: 'Available Exams', path: '/dashboard/available-exams', icon: <FaLaptopCode /> },
